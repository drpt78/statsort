...
| Distribution / N | std::sort  | statsort  | spreadsort   | pdqsort| flat_stable_sort| speedup | 
|---|---|---|---|---|---|---|
| Uniform    n=10000 | 0.51 ms |0.17 ms |0.17 ms |0.24 ms |0.53 ms |    2.96x |
| Gaussian   n=10000 | 0.50 ms |0.18 ms |0.16 ms |0.24 ms |0.52 ms |    2.86x |
| Exponential n=10000 | 0.49 ms |0.17 ms |0.17 ms |0.24 ms |0.52 ms |    2.86x |
|---|---|---|---|---|---|---|
| Uniform    n=100000 | 6.16 ms |2.29 ms |2.51 ms |2.80 ms |6.87 ms |    2.69x |
| Gaussian   n=100000 | 6.23 ms |2.40 ms |2.47 ms |2.82 ms |6.88 ms |    2.60x |
| Exponential n=100000 | 6.23 ms |2.34 ms |2.41 ms |2.77 ms |6.86 ms |    2.66x |
|---|---|---|---|---|---|---|
| Uniform    n=1000000 | 73.74 ms |36.47 ms |40.30 ms |31.85 ms |87.95 ms |    2.02x |
| Gaussian   n=1000000 | 73.77 ms |26.92 ms |31.06 ms |31.80 ms |87.80 ms |    2.74x |
| Exponential n=1000000 | 74.13 ms |26.88 ms |28.70 ms |31.91 ms |87.96 ms |    2.76x |
|---|---|---|---|---|---|---|
| Uniform    n=10000000 | 862.86 ms |308.31 ms |250.78 ms |357.83 ms |1065.12 ms |    2.80x |
| Gaussian   n=10000000 | 858.02 ms |302.48 ms |333.87 ms |354.95 ms |1064.77 ms |    2.84x |
| Exponential n=10000000 | 861.87 ms |308.74 ms |239.68 ms |356.98 ms |1064.65 ms |    2.79x |
|---|---|---|---|---|---|---|
| Uniform    n=100000000 | 9812.21 ms |2954.94 ms |3370.54 ms |3964.37 ms |12401.84 ms |    3.32x |
| Gaussian   n=100000000 | 9791.47 ms |3120.74 ms |3250.93 ms |3913.93 ms |12415.90 ms |    3.14x |
| Exponential n=100000000 | 9846.89 ms |3169.41 ms |3094.92 ms |3943.50 ms |12476.51 ms |    3.11x |
